...
2) ITCZ_map_loc_ERA5_GPCP.py – ITCZ methodology verification using ERA5, NCEP Reanalysis 2 and GPCP datasets
...
7) OptimESM_pr_evaluation.py – Evaluates precipitation in the historical runs in the models participating in TIPMIP
